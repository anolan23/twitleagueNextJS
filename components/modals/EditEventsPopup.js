...
function EditEventsPopup(props) {
  ...
  const getOpponents = async () => {
    const opponents = await backend.get(
      `/api/leagues/${props.team.league_name}/teams`
    );
...
export default connect(mapStateToProps, { toggleEditEventsPopup })(
  EditEventsPopup
);

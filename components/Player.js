    ...
    return(
            <div className={player["player"]} key={props.key}>
                ...
                <div className={player["player__text"]}>
                    ...
                    <div className={player["player__text--sub"] + " muted"}>{`@${props.username}`}</div>
                </div>
                <div className={player["player__actions"]}>
                    <TwitButtton color="twit-button--primary" outline="twit-button--primary--outline">Scout</TwitButtton>
                </div>
            </div>
    )
}
